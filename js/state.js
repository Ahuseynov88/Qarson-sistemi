...
export const state = {
  ...
  _selectedTableMgmtId: null,
  _selectedSupplierMgmtId: null,
  // Banket və Tədbirlərin İdarə Edilməsi modulu
  banquetHalls: [],
  banquetEventTypes: [],
  banquetEvents: [],
  _selectedHallId: null,
  _selectedEventId: null,
  _banquetCalendarView: 'month',
  _banquetCalendarCursor: null,
  _banquetSelectedDay: null,
